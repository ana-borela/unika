...
@section('content')
    ...
    <section id="banner">
        ...
        <div class="container-fluid">
            <div class="row"> 
                ...
                <div class="col-md-12 banner-image parallax img-fluid" style="background-image: url('{{ asset('images/banner01.jpg') }}')">
        ...
        <div class="container py-5 text-center" data-aos="fade-up">
            <div class="row">
                ...
                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Desenvolvimento de sistemas</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Desenvolvimento de websites</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Consultoria em TI</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Redes & Conectividade</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Manutenção de servidores</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Assistência técnica</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Soluções de Backup</h2>
                </div>

                <div class="service-box col-12 col-md-3 p-5 hvr-grow">
                    <h2 class="service-title">Helpdesk Local</h2>
                </div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-12 col-md-8">
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <div class="about-content col-md-6 p-4 d-flex flex-column position-static bg-white" data-aos="fade-right">
    ...
    <section id="system">
        ...
        <div class="system container p-3" data-aos="fade-up" data-aos-duration="500" data-aos-easing="linear">
            <div class="row">
    ...
    <section id="partners">
        ...
        <div class="carousel slide" data-bs-ride="carousel" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 px-3">
                            <div class="row overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                                ...
                                <div class="col-auto pt-5 border-start">
                                    <img class="user-images image-fluid mx-auto d-block"
                        ...
                        <div class="col-12 col-md-6 px-3">
                            <div class="row overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                                ...
                                <div class="col p-4 d-flex flex-column position-static">
                                    ...
                                    <strong>MANOEL RODRIGUES NETO</strong>
